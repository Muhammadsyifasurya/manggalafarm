...
const Dashboard = () => {
  ...
  useEffect(()=> {
    ...
    console.log("nilaiNTU:", sensorData?.kekeruhan.nilaiNTU);
  })
      ...
      <div className="mx-[100px] 3xl:mx-[300px] mt-10">
        <div className="flex flex-wrap gap-4 justify-between">
          <div className="bg-white rounded-3xl shadow-[0px_4px_16px_rgba(0,0,0,0.1)] p-4 w-[270px] flex flex-col items-center justify-center h-[129px]">
            ...
            <h2 className="text-2xl font-semibold text-[#27445D]">{sensorData?.kekeruhan.kekeruhanAir}</h2>
          </div>
          <div className="bg-white rounded-3xl shadow-[0px_4px_16px_rgba(0,0,0,0.1)] p-4 w-[270px] flex flex-col items-center justify-center h-[129px]">
            <p className="text-gray-500 text-sm mb-1">Status Pakan</p>
            <h2 className="text-2xl font-semibold text-[#27445D]">{sensorData?.ultrasonic.kapasitasPakan}</h2>
          </div>
          <div className="bg-white rounded-3xl shadow-[0px_4px_16px_rgba(0,0,0,0.1)] p-4 w-[270px] flex flex-col items-center justify-center h-[129px]">
            <p className="text-gray-500 text-sm mb-1">Status Pompa (Buang)</p>
            <h2 className="text-2xl font-semibold text-[#27445D]">{sensorData?.kekeruhan.pompaBuang}</h2>
          </div>
          <div className="bg-white rounded-3xl shadow-[0px_4px_16px_rgba(0,0,0,0.1)] p-4 w-[270px] flex flex-col items-center justify-center h-[129px]">
            <p className="text-gray-500 text-sm mb-1">Status Pompa (Isi)</p>
            <h2 className="text-2xl font-semibold text-[#27445D]">{sensorData?.kekeruhan.pompaIsi}</h2>
          </div>
          <div className="bg-white rounded-3xl shadow-[0px_4px_16px_rgba(0,0,0,0.1)] p-4 w-[270px] flex flex-col items-center justify-center h-[129px]">
          ...
          <div className="bg-white rounded-3xl shadow-[0px_4px_16px_rgba(0,0,0,0.1)] p-4 w-[270px] flex flex-col items-center justify-center h-[129px]">
            ...
            <h2 className="text-2xl font-semibold text-[#27445D]">{sensorData?.kekeruhan.katupWadahPakan}</h2>
          </div>
        </div>
      </div>
